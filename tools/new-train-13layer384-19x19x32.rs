    ...
    for tid in 0 .. num_workers {
      ...
      scope.execute(move || {
        ...
        let mut arch_worker = PipelineArchWorker::new(
            batch_size,
            arch_cfg,
            PathBuf::from("models/tmp_gogodb_w2015_alphav3_new_action_13layer384_19x19x32"),
            tid,
            shared_seed,
            &arch_shared,
            atomic_data,
        ...
        let dataset_cfg = DatasetConfig::open(&PathBuf::from("data/gogodb_w2015_alphav3_19x19x32_episode.data"));
