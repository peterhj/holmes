    ...
    for tid in 0 .. num_workers {
      ...
      scope.execute(move || {
        ...
        let mut arch_worker = PipelineArchWorker::new(
            batch_size,
            arch_cfg,
            //PathBuf::from("models/tmp_gogodb_w2015_alphapatternv3m_new_action_1layer16_19x19x16"),
            PathBuf::from("models/gogodb_w2015-preproc-alphapatternv3m_19x19x8_1layer5x5"),
            tid,
            shared_seed,
            &arch_shared,
            atomic_data,
        ...
        //let dataset_cfg = DatasetConfig::open(&PathBuf::from("data/gogodb_w2015_alphapatternv3m_19x19x16_episode.data"));
