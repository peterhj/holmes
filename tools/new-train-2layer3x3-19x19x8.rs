...
fn train() {
  ...
  let conv1_layer_cfg = Conv2dLayerConfig{
    ...
    init_weights:   ParamsInitialization::Uniform{half_range: 0.01},
  };
    ...
    for tid in 0 .. num_workers {
      ...
      scope.execute(move || {
        ...
        let mut arch_worker = PipelineArchWorker::new(
            batch_size,
            arch_cfg,
            PathBuf::from("models/gogodb_w2015-preproc-alphapatternv3m_19x19x8_2layer3x3_64ch"),
            //PathBuf::from("models/kgs_ugo_201505-preproc-alphapatternv3m_19x19x8_2layer3x3_64ch"),
            tid,
            shared_seed,
            &arch_shared,
            atomic_data,
        ...
        let dataset_cfg = DatasetConfig::open(&PathBuf::from("datasets/gogodb_w2015-preproc-alphapatternv3m_19x19x8.data"));
        //let dataset_cfg = DatasetConfig::open(&PathBuf::from("datasets/kgs_ugo_201505-preproc-alphapatternv3m_19x19x8.data"));
