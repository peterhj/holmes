    ...
    for tid in 0 .. num_workers {
      ...
      scope.execute(move || {
        ...
        let mut arch_worker = PipelineArchWorker::new(
            batch_size,
            arch_cfg,
            PathBuf::from("models/gogodb_w2015-preproc-alphapatternnokov3m_19x19x7_2layer3x3_8ch"),
            //PathBuf::from("models/kgs_ugo_201505-preproc-alphapatternnokov3m_19x19x7_2layer3x3_64ch"),
            tid,
            shared_seed,
            &arch_shared,
            atomic_data,
        ...
        //let dataset_cfg = DatasetConfig::open(&PathBuf::from("datasets/kgs_ugo_201505-preproc-alphapatternnokov3m_19x19x7.data"));
