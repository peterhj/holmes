...
v8sf sin256_ps(v8sf x) { // any x
  ...
  */
  ...
  imm2_1 = _mm_and_si256(imm2_1, *(v4si*)_pi32avx_inv1);
  imm2_2 = _mm_and_si256(imm2_2, *(v4si*)_pi32avx_inv1);

  COPY_XMM_TO_IMM(imm2_1,imm2_2,imm2);
  y = _mm256_cvtepi32_ps(imm2);

  imm0_1 = _mm_and_si256(imm2_1, *(v4si*)_pi32avx_4);
  imm0_2 = _mm_and_si256(imm2_2, *(v4si*)_pi32avx_4);
  ...
  imm2_1 = _mm_and_si256(imm2_1, *(v4si*)_pi32avx_2);
  imm2_2 = _mm_and_si256(imm2_2, *(v4si*)_pi32avx_2);
...
v8sf cos256_ps(v8sf x) { // any x
  ...
  imm0_1 = _mm_andnot_si256(imm2_1, *(v4si*)_pi32avx_4);
  imm0_2 = _mm_andnot_si256(imm2_2, *(v4si*)_pi32avx_4);
...
void sincos256_ps(v8sf x, v8sf *s, v8sf *c) {
  ...
  imm4_1 = _mm_andnot_si256(imm4_1, *(v4si*)_pi32avx_4);
  imm4_2 = _mm_andnot_si256(imm4_2, *(v4si*)_pi32avx_4);
